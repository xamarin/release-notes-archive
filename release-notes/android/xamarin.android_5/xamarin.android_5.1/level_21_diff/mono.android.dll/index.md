---
id: 86EC7D9D-E033-49B4-B4BD-5D6577F1892A
...
```
public Android.Media.AudioAttributes AudioAttributesDefault { get; set; }
	public Android.OS.IParcelableCreator Creator { get; set; }
```
...
```
public CameraCharacteristics.Key ColorCorrectionAvailableAberrationModes { get; set; }
	public CameraCharacteristics.Key ControlAeAvailableAntibandingModes { get; set; }
	public CameraCharacteristics.Key ControlAeAvailableModes { get; set; }
	public CameraCharacteristics.Key ControlAeAvailableTargetFpsRanges { get; set; }
	public CameraCharacteristics.Key ControlAeCompensationRange { get; set; }
	public CameraCharacteristics.Key ControlAeCompensationStep { get; set; }
	public CameraCharacteristics.Key ControlAfAvailableModes { get; set; }
	public CameraCharacteristics.Key ControlAvailableEffects { get; set; }
	public CameraCharacteristics.Key ControlAvailableSceneModes { get; set; }
	public CameraCharacteristics.Key ControlAvailableVideoStabilizationModes { get; set; }
	public CameraCharacteristics.Key ControlAwbAvailableModes { get; set; }
	public CameraCharacteristics.Key ControlMaxRegionsAe { get; set; }
	public CameraCharacteristics.Key ControlMaxRegionsAf { get; set; }
	public CameraCharacteristics.Key ControlMaxRegionsAwb { get; set; }
	public CameraCharacteristics.Key EdgeAvailableEdgeModes { get; set; }
	public CameraCharacteristics.Key FlashInfoAvailable { get; set; }
	public CameraCharacteristics.Key HotPixelAvailableHotPixelModes { get; set; }
	public CameraCharacteristics.Key InfoSupportedHardwareLevel { get; set; }
	public CameraCharacteristics.Key JpegAvailableThumbnailSizes { get; set; }
	public CameraCharacteristics.Key LensFacing { get; set; }
	public CameraCharacteristics.Key LensInfoAvailableApertures { get; set; }
	public CameraCharacteristics.Key LensInfoAvailableFilterDensities { get; set; }
	public CameraCharacteristics.Key LensInfoAvailableFocalLengths { get; set; }
	public CameraCharacteristics.Key LensInfoAvailableOpticalStabilization { get; set; }
	public CameraCharacteristics.Key LensInfoFocusDistanceCalibration { get; set; }
	public CameraCharacteristics.Key LensInfoHyperfocalDistance { get; set; }
	public CameraCharacteristics.Key LensInfoMinimumFocusDistance { get; set; }
	public CameraCharacteristics.Key NoiseReductionAvailableNoiseReductionModes { get; set; }
	public CameraCharacteristics.Key RequestAvailableCapabilities { get; set; }
	public CameraCharacteristics.Key RequestMaxNumOutputProc { get; set; }
	public CameraCharacteristics.Key RequestMaxNumOutputProcStalling { get; set; }
	public CameraCharacteristics.Key RequestMaxNumOutputRaw { get; set; }
	public CameraCharacteristics.Key RequestPartialResultCount { get; set; }
	public CameraCharacteristics.Key RequestPipelineMaxDepth { get; set; }
	public CameraCharacteristics.Key ScalerAvailableMaxDigitalZoom { get; set; }
	public CameraCharacteristics.Key ScalerCroppingType { get; set; }
	public CameraCharacteristics.Key ScalerStreamConfigurationMap { get; set; }
	public CameraCharacteristics.Key SensorAvailableTestPatternModes { get; set; }
	public CameraCharacteristics.Key SensorBlackLevelPattern { get; set; }
	public CameraCharacteristics.Key SensorCalibrationTransform1 { get; set; }
	public CameraCharacteristics.Key SensorCalibrationTransform2 { get; set; }
	public CameraCharacteristics.Key SensorColorTransform1 { get; set; }
	public CameraCharacteristics.Key SensorColorTransform2 { get; set; }
	public CameraCharacteristics.Key SensorForwardMatrix1 { get; set; }
	public CameraCharacteristics.Key SensorForwardMatrix2 { get; set; }
	public CameraCharacteristics.Key SensorInfoActiveArraySize { get; set; }
	public CameraCharacteristics.Key SensorInfoColorFilterArrangement { get; set; }
	public CameraCharacteristics.Key SensorInfoExposureTimeRange { get; set; }
	public CameraCharacteristics.Key SensorInfoMaxFrameDuration { get; set; }
	public CameraCharacteristics.Key SensorInfoPhysicalSize { get; set; }
	public CameraCharacteristics.Key SensorInfoPixelArraySize { get; set; }
	public CameraCharacteristics.Key SensorInfoSensitivityRange { get; set; }
	public CameraCharacteristics.Key SensorInfoTimestampSource { get; set; }
	public CameraCharacteristics.Key SensorInfoWhiteLevel { get; set; }
	public CameraCharacteristics.Key SensorMaxAnalogSensitivity { get; set; }
	public CameraCharacteristics.Key SensorOrientation { get; set; }
	public CameraCharacteristics.Key SensorReferenceIlluminant1 { get; set; }
	public CameraCharacteristics.Key SensorReferenceIlluminant2 { get; set; }
	public CameraCharacteristics.Key StatisticsInfoAvailableFaceDetectModes { get; set; }
	public CameraCharacteristics.Key StatisticsInfoAvailableHotPixelMapModes { get; set; }
	public CameraCharacteristics.Key StatisticsInfoMaxFaceCount { get; set; }
	public CameraCharacteristics.Key SyncMaxLatency { get; set; }
	public CameraCharacteristics.Key TonemapAvailableToneMapModes { get; set; }
	public CameraCharacteristics.Key TonemapMaxCurvePoints { get; set; }
```
...
```
public CaptureRequest.Key BlackLevelLock { get; set; }
	public CaptureRequest.Key ColorCorrectionAberrationMode { get; set; }
	public CaptureRequest.Key ColorCorrectionGains { get; set; }
	public CaptureRequest.Key ColorCorrectionMode { get; set; }
	public CaptureRequest.Key ColorCorrectionTransform { get; set; }
	public CaptureRequest.Key ControlAeAntibandingMode { get; set; }
	public CaptureRequest.Key ControlAeExposureCompensation { get; set; }
	public CaptureRequest.Key ControlAeLock { get; set; }
	public CaptureRequest.Key ControlAeMode { get; set; }
	public CaptureRequest.Key ControlAePrecaptureTrigger { get; set; }
	public CaptureRequest.Key ControlAeRegions { get; set; }
	public CaptureRequest.Key ControlAeTargetFpsRange { get; set; }
	public CaptureRequest.Key ControlAfMode { get; set; }
	public CaptureRequest.Key ControlAfRegions { get; set; }
	public CaptureRequest.Key ControlAfTrigger { get; set; }
	public CaptureRequest.Key ControlAwbLock { get; set; }
	public CaptureRequest.Key ControlAwbMode { get; set; }
	public CaptureRequest.Key ControlAwbRegions { get; set; }
	public CaptureRequest.Key ControlCaptureIntent { get; set; }
	public CaptureRequest.Key ControlEffectMode { get; set; }
	public CaptureRequest.Key ControlMode { get; set; }
	public CaptureRequest.Key ControlSceneMode { get; set; }
	public CaptureRequest.Key ControlVideoStabilizationMode { get; set; }
	public Android.OS.IParcelableCreator Creator { get; set; }
	public CaptureRequest.Key EdgeMode { get; set; }
	public CaptureRequest.Key FlashMode { get; set; }
	public CaptureRequest.Key HotPixelMode { get; set; }
	public CaptureRequest.Key JpegGpsLocation { get; set; }
	public CaptureRequest.Key JpegOrientation { get; set; }
	public CaptureRequest.Key JpegQuality { get; set; }
	public CaptureRequest.Key JpegThumbnailQuality { get; set; }
	public CaptureRequest.Key JpegThumbnailSize { get; set; }
	public CaptureRequest.Key LensAperture { get; set; }
	public CaptureRequest.Key LensFilterDensity { get; set; }
	public CaptureRequest.Key LensFocalLength { get; set; }
	public CaptureRequest.Key LensFocusDistance { get; set; }
	public CaptureRequest.Key LensOpticalStabilizationMode { get; set; }
	public CaptureRequest.Key NoiseReductionMode { get; set; }
	public CaptureRequest.Key ScalerCropRegion { get; set; }
	public CaptureRequest.Key SensorExposureTime { get; set; }
	public CaptureRequest.Key SensorFrameDuration { get; set; }
	public CaptureRequest.Key SensorSensitivity { get; set; }
	public CaptureRequest.Key SensorTestPatternData { get; set; }
	public CaptureRequest.Key SensorTestPatternMode { get; set; }
	public CaptureRequest.Key ShadingMode { get; set; }
	public CaptureRequest.Key StatisticsFaceDetectMode { get; set; }
	public CaptureRequest.Key StatisticsHotPixelMapMode { get; set; }
	public CaptureRequest.Key StatisticsLensShadingMapMode { get; set; }
	public CaptureRequest.Key TonemapCurve { get; set; }
	public CaptureRequest.Key TonemapMode { get; set; }
```
...
```
public CaptureResult.Key BlackLevelLock { get; set; }
	public CaptureResult.Key ColorCorrectionAberrationMode { get; set; }
	public CaptureResult.Key ColorCorrectionGains { get; set; }
	public CaptureResult.Key ColorCorrectionMode { get; set; }
	public CaptureResult.Key ColorCorrectionTransform { get; set; }
	public CaptureResult.Key ControlAeAntibandingMode { get; set; }
	public CaptureResult.Key ControlAeExposureCompensation { get; set; }
	public CaptureResult.Key ControlAeLock { get; set; }
	public CaptureResult.Key ControlAeMode { get; set; }
	public CaptureResult.Key ControlAePrecaptureTrigger { get; set; }
	public CaptureResult.Key ControlAeRegions { get; set; }
	public CaptureResult.Key ControlAeState { get; set; }
	public CaptureResult.Key ControlAeTargetFpsRange { get; set; }
	public CaptureResult.Key ControlAfMode { get; set; }
	public CaptureResult.Key ControlAfRegions { get; set; }
	public CaptureResult.Key ControlAfState { get; set; }
	public CaptureResult.Key ControlAfTrigger { get; set; }
	public CaptureResult.Key ControlAwbLock { get; set; }
	public CaptureResult.Key ControlAwbMode { get; set; }
	public CaptureResult.Key ControlAwbRegions { get; set; }
	public CaptureResult.Key ControlAwbState { get; set; }
	public CaptureResult.Key ControlCaptureIntent { get; set; }
	public CaptureResult.Key ControlEffectMode { get; set; }
	public CaptureResult.Key ControlMode { get; set; }
	public CaptureResult.Key ControlSceneMode { get; set; }
	public CaptureResult.Key ControlVideoStabilizationMode { get; set; }
	public CaptureResult.Key EdgeMode { get; set; }
	public CaptureResult.Key FlashMode { get; set; }
	public CaptureResult.Key FlashState { get; set; }
	public CaptureResult.Key HotPixelMode { get; set; }
	public CaptureResult.Key JpegGpsLocation { get; set; }
	public CaptureResult.Key JpegOrientation { get; set; }
	public CaptureResult.Key JpegQuality { get; set; }
	public CaptureResult.Key JpegThumbnailQuality { get; set; }
	public CaptureResult.Key JpegThumbnailSize { get; set; }
	public CaptureResult.Key LensAperture { get; set; }
	public CaptureResult.Key LensFilterDensity { get; set; }
	public CaptureResult.Key LensFocalLength { get; set; }
	public CaptureResult.Key LensFocusDistance { get; set; }
	public CaptureResult.Key LensFocusRange { get; set; }
	public CaptureResult.Key LensOpticalStabilizationMode { get; set; }
	public CaptureResult.Key LensState { get; set; }
	public CaptureResult.Key NoiseReductionMode { get; set; }
	public CaptureResult.Key RequestPipelineDepth { get; set; }
	public CaptureResult.Key ScalerCropRegion { get; set; }
	public CaptureResult.Key SensorExposureTime { get; set; }
	public CaptureResult.Key SensorFrameDuration { get; set; }
	public CaptureResult.Key SensorGreenSplit { get; set; }
	public CaptureResult.Key SensorNeutralColorPoint { get; set; }
	public CaptureResult.Key SensorNoiseProfile { get; set; }
	public CaptureResult.Key SensorRollingShutterSkew { get; set; }
	public CaptureResult.Key SensorSensitivity { get; set; }
	public CaptureResult.Key SensorTestPatternData { get; set; }
	public CaptureResult.Key SensorTestPatternMode { get; set; }
	public CaptureResult.Key SensorTimestamp { get; set; }
	public CaptureResult.Key ShadingMode { get; set; }
	public CaptureResult.Key StatisticsFaceDetectMode { get; set; }
	public CaptureResult.Key StatisticsFaces { get; set; }
	public CaptureResult.Key StatisticsHotPixelMap { get; set; }
	public CaptureResult.Key StatisticsHotPixelMapMode { get; set; }
	public CaptureResult.Key StatisticsLensShadingCorrectionMap { get; set; }
	public CaptureResult.Key StatisticsLensShadingMapMode { get; set; }
	public CaptureResult.Key StatisticsSceneFlicker { get; set; }
	public CaptureResult.Key TonemapCurve { get; set; }
	public CaptureResult.Key TonemapMode { get; set; }
```
...
public string Board { get; set; }
	...
	public System.Collections.Generic.IList<string> Supported32BitAbis { get; set; }
	public System.Collections.Generic.IList<string> Supported64BitAbis { get; set; }
	public System.Collections.Generic.IList<string> SupportedAbis { get; set; }
...
```
public IParcelableCreator Creator { get; set; }
	public PersistableBundle Empty { get; set; }
```
...
public Android.Net.Uri ContentFilterUri { get; set; }
	public Android.Net.Uri ContentUri { get; set; }
	public Android.Net.Uri ContentUriWithVoicemail { get; set; }
```
...
```
public Android.Net.Uri ContentFilterUri { get; set; }
	public Android.Net.Uri ContentFrequentUri { get; set; }
	public Android.Net.Uri ContentGroupUri { get; set; }
	public Android.Net.Uri ContentLookupUri { get; set; }
	public Android.Net.Uri ContentMultiVcardUri { get; set; }
...
```
public Android.Net.Uri ContentFilterUri { get; set; }
	public Android.Net.Uri EnterpriseContentFilterUri { get; set; }
```
...
```
public int AfInet { get; set; }
	public int AfInet6 { get; set; }
	public int AfUnix { get; set; }
	public int AfUnspec { get; set; }
	public int AiAddrconfig { get; set; }
	public int AiAll { get; set; }
	public int AiCanonname { get; set; }
	public int AiNumerichost { get; set; }
	public int AiNumericserv { get; set; }
	public int AiPassive { get; set; }
	public int AiV4mapped { get; set; }
	public int CapAuditControl { get; set; }
	public int CapAuditWrite { get; set; }
	public int CapBlockSuspend { get; set; }
	public int CapChown { get; set; }
	public int CapDacOverride { get; set; }
	public int CapDacReadSearch { get; set; }
	public int CapFowner { get; set; }
	public int CapFsetid { get; set; }
	public int CapIpcLock { get; set; }
	public int CapIpcOwner { get; set; }
	public int CapKill { get; set; }
	public int CapLastCap { get; set; }
	public int CapLease { get; set; }
	public int CapLinuxImmutable { get; set; }
	public int CapMacAdmin { get; set; }
	public int CapMacOverride { get; set; }
	public int CapMknod { get; set; }
	public int CapNetAdmin { get; set; }
	public int CapNetBindService { get; set; }
	public int CapNetBroadcast { get; set; }
	public int CapNetRaw { get; set; }
	public int CapSetfcap { get; set; }
	public int CapSetgid { get; set; }
	public int CapSetpcap { get; set; }
	public int CapSetuid { get; set; }
	public int CapSysAdmin { get; set; }
	public int CapSysBoot { get; set; }
	public int CapSysChroot { get; set; }
	public int CapSyslog { get; set; }
	public int CapSysModule { get; set; }
	public int CapSysNice { get; set; }
	public int CapSysPacct { get; set; }
	public int CapSysPtrace { get; set; }
	public int CapSysRawio { get; set; }
	public int CapSysResource { get; set; }
	public int CapSysTime { get; set; }
	public int CapSysTtyConfig { get; set; }
	public int CapWakeAlarm { get; set; }
	public int E2big { get; set; }
	public int Eacces { get; set; }
	public int Eaddrinuse { get; set; }
	public int Eaddrnotavail { get; set; }
	public int Eafnosupport { get; set; }
	public int Eagain { get; set; }
	public int EaiAgain { get; set; }
	public int EaiBadflags { get; set; }
	public int EaiFail { get; set; }
	public int EaiFamily { get; set; }
	public int EaiMemory { get; set; }
	public int EaiNodata { get; set; }
	public int EaiNoname { get; set; }
	public int EaiOverflow { get; set; }
	public int EaiService { get; set; }
	public int EaiSocktype { get; set; }
	public int EaiSystem { get; set; }
	public int Ealready { get; set; }
	public int Ebadf { get; set; }
	public int Ebadmsg { get; set; }
	public int Ebusy { get; set; }
	public int Ecanceled { get; set; }
	public int Echild { get; set; }
	public int Econnaborted { get; set; }
	public int Econnrefused { get; set; }
	public int Econnreset { get; set; }
	public int Edeadlk { get; set; }
	public int Edestaddrreq { get; set; }
	public int Edom { get; set; }
	public int Edquot { get; set; }
	public int Eexist { get; set; }
	public int Efault { get; set; }
	public int Efbig { get; set; }
	public int Ehostunreach { get; set; }
	public int Eidrm { get; set; }
	public int Eilseq { get; set; }
	public int Einprogress { get; set; }
	public int Eintr { get; set; }
	public int Einval { get; set; }
	public int Eio { get; set; }
	public int Eisconn { get; set; }
	public int Eisdir { get; set; }
	public int Eloop { get; set; }
	public int Emfile { get; set; }
	public int Emlink { get; set; }
	public int Emsgsize { get; set; }
	public int Emultihop { get; set; }
	public int Enametoolong { get; set; }
	public int Enetdown { get; set; }
	public int Enetreset { get; set; }
	public int Enetunreach { get; set; }
	public int Enfile { get; set; }
	public int Enobufs { get; set; }
	public int Enodata { get; set; }
	public int Enodev { get; set; }
	public int Enoent { get; set; }
	public int Enoexec { get; set; }
	public int Enolck { get; set; }
	public int Enolink { get; set; }
	public int Enomem { get; set; }
	public int Enomsg { get; set; }
	public int Enoprotoopt { get; set; }
	public int Enospc { get; set; }
	public int Enosr { get; set; }
	public int Enostr { get; set; }
	public int Enosys { get; set; }
	public int Enotconn { get; set; }
	public int Enotdir { get; set; }
	public int Enotempty { get; set; }
	public int Enotsock { get; set; }
	public int Enotsup { get; set; }
	public int Enotty { get; set; }
	public int Enxio { get; set; }
	public int Eopnotsupp { get; set; }
	public int Eoverflow { get; set; }
	public int Eperm { get; set; }
	public int Epipe { get; set; }
	public int Eproto { get; set; }
	public int Eprotonosupport { get; set; }
	public int Eprototype { get; set; }
	public int Erange { get; set; }
	public int Erofs { get; set; }
	public int Espipe { get; set; }
	public int Esrch { get; set; }
	public int Estale { get; set; }
	public int Etime { get; set; }
	public int Etimedout { get; set; }
	public int Etxtbsy { get; set; }
	public int Exdev { get; set; }
	public int ExitFailure { get; set; }
	public int ExitSuccess { get; set; }
	public int FdCloexec { get; set; }
	public int FDupfd { get; set; }
	public int FGetfd { get; set; }
	public int FGetfl { get; set; }
	public int FGetlk { get; set; }
	public int FGetlk64 { get; set; }
	public int FGetown { get; set; }
	public int Fionread { get; set; }
	public int FOk { get; set; }
	public int FRdlck { get; set; }
	public int FSetfd { get; set; }
	public int FSetfl { get; set; }
	public int FSetlk { get; set; }
	public int FSetlk64 { get; set; }
	public int FSetlkw { get; set; }
	public int FSetlkw64 { get; set; }
	public int FSetown { get; set; }
	public int FUnlck { get; set; }
	public int FWrlck { get; set; }
	public int IfaFDadfailed { get; set; }
	public int IfaFDeprecated { get; set; }
	public int IfaFHomeaddress { get; set; }
	public int IfaFNodad { get; set; }
	public int IfaFOptimistic { get; set; }
	public int IfaFPermanent { get; set; }
	public int IfaFSecondary { get; set; }
	public int IfaFTemporary { get; set; }
	public int IfaFTentative { get; set; }
	public int IffAllmulti { get; set; }
	public int IffAutomedia { get; set; }
	public int IffBroadcast { get; set; }
	public int IffDebug { get; set; }
	public int IffDynamic { get; set; }
	public int IffLoopback { get; set; }
	public int IffMaster { get; set; }
	public int IffMulticast { get; set; }
	public int IffNoarp { get; set; }
	public int IffNotrailers { get; set; }
	public int IffPointopoint { get; set; }
	public int IffPortsel { get; set; }
	public int IffPromisc { get; set; }
	public int IffRunning { get; set; }
	public int IffSlave { get; set; }
	public int IffUp { get; set; }
	public int IpMulticastIf { get; set; }
	public int IpMulticastLoop { get; set; }
	public int IpMulticastTtl { get; set; }
	public int IpprotoIcmp { get; set; }
	public int IpprotoIcmpv6 { get; set; }
	public int IpprotoIp { get; set; }
	public int IpprotoIpv6 { get; set; }
	public int IpprotoRaw { get; set; }
	public int IpprotoTcp { get; set; }
	public int IpprotoUdp { get; set; }
	public int IpTos { get; set; }
	public int IpTtl { get; set; }
	public int Ipv6Checksum { get; set; }
	public int Ipv6MulticastHops { get; set; }
	public int Ipv6MulticastIf { get; set; }
	public int Ipv6MulticastLoop { get; set; }
	public int Ipv6Recvdstopts { get; set; }
	public int Ipv6Recvhoplimit { get; set; }
	public int Ipv6Recvhopopts { get; set; }
	public int Ipv6Recvpktinfo { get; set; }
	public int Ipv6Recvrthdr { get; set; }
	public int Ipv6Recvtclass { get; set; }
	public int Ipv6Tclass { get; set; }
	public int Ipv6UnicastHops { get; set; }
	public int Ipv6V6only { get; set; }
	public int MapFixed { get; set; }
	public int MapPrivate { get; set; }
	public int MapShared { get; set; }
	public int McastBlockSource { get; set; }
	public int McastJoinGroup { get; set; }
	public int McastJoinSourceGroup { get; set; }
	public int McastLeaveGroup { get; set; }
	public int McastLeaveSourceGroup { get; set; }
	public int McastUnblockSource { get; set; }
	public int MclCurrent { get; set; }
	public int MclFuture { get; set; }
	public int MsAsync { get; set; }
	public int MsgCtrunc { get; set; }
	public int MsgDontroute { get; set; }
	public int MsgEor { get; set; }
	public int MsgOob { get; set; }
	public int MsgPeek { get; set; }
	public int MsgTrunc { get; set; }
	public int MsgWaitall { get; set; }
	public int MsInvalidate { get; set; }
	public int MsSync { get; set; }
	public int NiDgram { get; set; }
	public int NiNamereqd { get; set; }
	public int NiNofqdn { get; set; }
	public int NiNumerichost { get; set; }
	public int NiNumericserv { get; set; }
	public int OAccmode { get; set; }
	public int OAppend { get; set; }
	public int OCreat { get; set; }
	public int OExcl { get; set; }
	public int ONoctty { get; set; }
	public int ONofollow { get; set; }
	public int ONonblock { get; set; }
	public int ORdonly { get; set; }
	public int ORdwr { get; set; }
	public int OSync { get; set; }
	public int OTrunc { get; set; }
	public int OWronly { get; set; }
	public int Pollerr { get; set; }
	public int Pollhup { get; set; }
	public int Pollin { get; set; }
	public int Pollnval { get; set; }
	public int Pollout { get; set; }
	public int Pollpri { get; set; }
	public int Pollrdband { get; set; }
	public int Pollrdnorm { get; set; }
	public int Pollwrband { get; set; }
	public int Pollwrnorm { get; set; }
	public int PrGetDumpable { get; set; }
	public int ProtExec { get; set; }
	public int ProtNone { get; set; }
	public int ProtRead { get; set; }
	public int ProtWrite { get; set; }
	public int PrSetDumpable { get; set; }
	public int PrSetNoNewPrivs { get; set; }
	public int ROk { get; set; }
	public int RtScopeHost { get; set; }
	public int RtScopeLink { get; set; }
	public int RtScopeNowhere { get; set; }
	public int RtScopeSite { get; set; }
	public int RtScopeUniverse { get; set; }
	public int Sc2CBind { get; set; }
	public int Sc2CDev { get; set; }
	public int Sc2CharTerm { get; set; }
	public int Sc2CVersion { get; set; }
	public int Sc2FortDev { get; set; }
	public int Sc2FortRun { get; set; }
	public int Sc2Localedef { get; set; }
	public int Sc2SwDev { get; set; }
	public int Sc2Upe { get; set; }
	public int Sc2Version { get; set; }
	public int ScAioListioMax { get; set; }
	public int ScAioMax { get; set; }
	public int ScAioPrioDeltaMax { get; set; }
	public int ScArgMax { get; set; }
	public int ScAsynchronousIo { get; set; }
	public int ScAtexitMax { get; set; }
	public int ScAvphysPages { get; set; }
	public int ScBcBaseMax { get; set; }
	public int ScBcDimMax { get; set; }
	public int ScBcScaleMax { get; set; }
	public int ScBcStringMax { get; set; }
	public int ScChildMax { get; set; }
	public int ScClkTck { get; set; }
	public int ScCollWeightsMax { get; set; }
	public int ScDelaytimerMax { get; set; }
	public int ScExprNestMax { get; set; }
	public int ScFsync { get; set; }
	public int ScGetgrRSizeMax { get; set; }
	public int ScGetpwRSizeMax { get; set; }
	public int ScIovMax { get; set; }
	public int ScJobControl { get; set; }
	public int ScLineMax { get; set; }
	public int ScLoginNameMax { get; set; }
	public int ScMappedFiles { get; set; }
	public int ScMemlock { get; set; }
	public int ScMemlockRange { get; set; }
	public int ScMemoryProtection { get; set; }
	public int ScMessagePassing { get; set; }
	public int ScMqOpenMax { get; set; }
	public int ScMqPrioMax { get; set; }
	public int ScNgroupsMax { get; set; }
	public int ScNprocessorsConf { get; set; }
	public int ScNprocessorsOnln { get; set; }
	public int ScOpenMax { get; set; }
	public int ScPagesize { get; set; }
	public int ScPageSize { get; set; }
	public int ScPassMax { get; set; }
	public int ScPhysPages { get; set; }
	public int ScPrioritizedIo { get; set; }
	public int ScPriorityScheduling { get; set; }
	public int ScRealtimeSignals { get; set; }
	public int ScReDupMax { get; set; }
	public int ScRtsigMax { get; set; }
	public int ScSavedIds { get; set; }
	public int ScSemaphores { get; set; }
	public int ScSemNsemsMax { get; set; }
	public int ScSemValueMax { get; set; }
	public int ScSharedMemoryObjects { get; set; }
	public int ScSigqueueMax { get; set; }
	public int ScStreamMax { get; set; }
	public int ScSynchronizedIo { get; set; }
	public int ScThreadAttrStackaddr { get; set; }
	public int ScThreadAttrStacksize { get; set; }
	public int ScThreadDestructorIterations { get; set; }
	public int ScThreadKeysMax { get; set; }
	public int ScThreadPrioInherit { get; set; }
	public int ScThreadPrioProtect { get; set; }
	public int ScThreadPriorityScheduling { get; set; }
	public int ScThreads { get; set; }
	public int ScThreadSafeFunctions { get; set; }
	public int ScThreadStackMin { get; set; }
	public int ScThreadThreadsMax { get; set; }
	public int ScTimerMax { get; set; }
	public int ScTimers { get; set; }
	public int ScTtyNameMax { get; set; }
	public int ScTznameMax { get; set; }
	public int ScVersion { get; set; }
	public int ScXbs5Ilp32Off32 { get; set; }
	public int ScXbs5Ilp32Offbig { get; set; }
	public int ScXbs5Lp64Off64 { get; set; }
	public int ScXbs5LpbigOffbig { get; set; }
	public int ScXopenCrypt { get; set; }
	public int ScXopenEnhI18n { get; set; }
	public int ScXopenLegacy { get; set; }
	public int ScXopenRealtime { get; set; }
	public int ScXopenRealtimeThreads { get; set; }
	public int ScXopenShm { get; set; }
	public int ScXopenUnix { get; set; }
	public int ScXopenVersion { get; set; }
	public int ScXopenXcuVersion { get; set; }
	public int SeekCur { get; set; }
	public int SeekEnd { get; set; }
	public int SeekSet { get; set; }
	public int ShutRd { get; set; }
	public int ShutRdwr { get; set; }
	public int ShutWr { get; set; }
	public int SIfblk { get; set; }
	public int SIfchr { get; set; }
	public int SIfdir { get; set; }
	public int SIfifo { get; set; }
	public int SIflnk { get; set; }
	public int SIfmt { get; set; }
	public int SIfreg { get; set; }
	public int SIfsock { get; set; }
	public int Sigabrt { get; set; }
	public int Sigalrm { get; set; }
	public int Sigbus { get; set; }
	public int Sigchld { get; set; }
	public int Sigcont { get; set; }
	public int Sigfpe { get; set; }
	public int Sighup { get; set; }
	public int Sigill { get; set; }
	public int Sigint { get; set; }
	public int Sigio { get; set; }
	public int Sigkill { get; set; }
	public int Sigpipe { get; set; }
	public int Sigprof { get; set; }
	public int Sigpwr { get; set; }
	public int Sigquit { get; set; }
	public int Sigrtmax { get; set; }
	public int Sigrtmin { get; set; }
	public int Sigsegv { get; set; }
	public int Sigstkflt { get; set; }
	public int Sigstop { get; set; }
	public int Sigsys { get; set; }
	public int Sigterm { get; set; }
	public int Sigtrap { get; set; }
	public int Sigtstp { get; set; }
	public int Sigttin { get; set; }
	public int Sigttou { get; set; }
	public int Sigurg { get; set; }
	public int Sigusr1 { get; set; }
	public int Sigusr2 { get; set; }
	public int Sigvtalrm { get; set; }
	public int Sigwinch { get; set; }
	public int Sigxcpu { get; set; }
	public int Sigxfsz { get; set; }
	public int Siocgifaddr { get; set; }
	public int Siocgifbrdaddr { get; set; }
	public int Siocgifdstaddr { get; set; }
	public int Siocgifnetmask { get; set; }
	public int SIrgrp { get; set; }
	public int SIroth { get; set; }
	public int SIrusr { get; set; }
	public int SIrwxg { get; set; }
	public int SIrwxo { get; set; }
	public int SIrwxu { get; set; }
	public int SIsgid { get; set; }
	public int SIsuid { get; set; }
	public int SIsvtx { get; set; }
	public int SIwgrp { get; set; }
	public int SIwoth { get; set; }
	public int SIwusr { get; set; }
	public int SIxgrp { get; set; }
	public int SIxoth { get; set; }
	public int SIxusr { get; set; }
	public int SoBindtodevice { get; set; }
	public int SoBroadcast { get; set; }
	public int SockDgram { get; set; }
	public int SockRaw { get; set; }
	public int SockSeqpacket { get; set; }
	public int SockStream { get; set; }
	public int SoDebug { get; set; }
	public int SoDontroute { get; set; }
	public int SoError { get; set; }
	public int SoKeepalive { get; set; }
	public int SoLinger { get; set; }
	public int SolSocket { get; set; }
	public int SoOobinline { get; set; }
	public int SoPasscred { get; set; }
	public int SoPeercred { get; set; }
	public int SoRcvbuf { get; set; }
	public int SoRcvlowat { get; set; }
	public int SoRcvtimeo { get; set; }
	public int SoReuseaddr { get; set; }
	public int SoSndbuf { get; set; }
	public int SoSndlowat { get; set; }
	public int SoSndtimeo { get; set; }
	public int SoType { get; set; }
	public int StderrFileno { get; set; }
	public int StdinFileno { get; set; }
	public int StdoutFileno { get; set; }
	public int TcpNodelay { get; set; }
	public int Wcontinued { get; set; }
	public int Wexited { get; set; }
	public int Wnohang { get; set; }
	public int Wnowait { get; set; }
	public int WOk { get; set; }
	public int Wstopped { get; set; }
	public int Wuntraced { get; set; }
	public int XOk { get; set; }
```
...
```
public Rational NaN { get; set; }
	public Rational NegativeInfinity { get; set; }
	public Rational PositiveInfinity { get; set; }
	public Rational Zero { get; set; }
```
...
protected System.Collections.Generic.IList<int> EmptyStateSet { get; set; }
	...
	public Android.Util.Property Z { get; set; }
```
...
```
public ViewOutlineProvider Background { get; set; }
	public ViewOutlineProvider Bounds { get; set; }
	public ViewOutlineProvider PaddedBounds { get; set; }
```
...
```
public AccessibilityNodeInfo.AccessibilityAction ActionAccessibilityFocus { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionClearAccessibilityFocus { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionClearFocus { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionClearSelection { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionClick { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionCollapse { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionCopy { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionCut { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionDismiss { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionExpand { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionFocus { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionLongClick { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionNextAtMovementGranularity { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionNextHtmlElement { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionPaste { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionPreviousAtMovementGranularity { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionPreviousHtmlElement { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionScrollBackward { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionScrollForward { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionSelect { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionSetSelection { get; set; }
	public AccessibilityNodeInfo.AccessibilityAction ActionSetText { get; set; }
```
...
public WebSettings.LayoutAlgorithm NarrowColumns { get; set; }
	...
	public WebSettings.LayoutAlgorithm TextAutosizing { get; set; }
```
...
```
public Charset Iso88591 { get; set; }
	public Charset UsAscii { get; set; }
	public Charset Utf16 { get; set; }
	public Charset Utf16be { get; set; }
	public Charset Utf16le { get; set; }
	public Charset Utf8 { get; set; }
```
...
```
public ForkJoinPool.IForkJoinWorkerThreadFactory DefaultForkJoinWorkerThreadFactory { get; set; }
```
...
```
public string AccessExternalDtd { get; set; }
	public string AccessExternalSchema { get; set; }
	public string AccessExternalStylesheet { get; set; }
```
