---
id: 55BF84E3-86CF-423D-8BBF-5CD50952A43C
...
# Mono.Android.dll
 ...
 <a name="Namespace:_Android.Annotation" class="injected"></a>


<h2 id="Android.Annotation">Namespace: Android.Annotation</h2>

 <a name="New_Type:_Android.Annotation.SuppressLint" class="injected"></a>


<h3 id="Android.Annotation.SuppressLint">New Type: Android.Annotation.SuppressLint</h3>

```
public abstract class SuppressLint : Java.Lang.Object, Java.Lang.Annotation.IAnnotation {
	
	protected SuppressLint (IntPtr javaReference, Android.Runtime.JniHandleOwnership transfer);
...
```
 ...
 <a name="New_Type:_Android.Annotation.SuppressLintAttribute" class="injected"></a>


<h3 id="Android.Annotation.SuppressLintAttribute">New Type: Android.Annotation.SuppressLintAttribute</h3>

```
public class SuppressLintAttribute : Attribute {
	
	public SuppressLintAttribute ();
}
```

 <a name="New_Type:_Android.Annotation.TargetApi" class="injected"></a>


<h3 id="Android.Annotation.TargetApi">New Type: Android.Annotation.TargetApi</h3>

```
public abstract class TargetApi : Java.Lang.Object, Java.Lang.Annotation.IAnnotation {
	
	protected TargetApi (IntPtr javaReference, Android.Runtime.JniHandleOwnership transfer);
...
```
 ...
 <a name="New_Type:_Android.Annotation.TargetApiAttribute" class="injected"></a>


<h3 id="Android.Annotation.TargetApiAttribute">New Type: Android.Annotation.TargetApiAttribute</h3>

```
public class TargetApiAttribute : Attribute {
	
	public TargetApiAttribute ();
}
```
...
```
 ...
 <a name="Type_Changed:_Android.App.ServiceAttribute" class="injected"></a>


<h3 id="Android.App.ServiceAttribute">Type Changed: Android.App.ServiceAttribute</h3>

Added:

```
public bool IsolatedProcess {
 		get;
 		set;
 	}
```
