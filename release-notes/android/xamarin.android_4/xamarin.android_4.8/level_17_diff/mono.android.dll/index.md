---
id: 75B18B90-BBA2-4614-8638-7B1B680B5BB3
...
<h2 id='Android.Annotation'>Namespace: Android.Annotation</h2>

<h3 id='Android.Annotation.ISuppressLint'>New Type: Android.Annotation.ISuppressLint</h3>

```
public interface ISuppressLint : Java.Lang.Annotation.IAnnotation, IDisposable, Android.Runtime.IJavaObject {
	
	string [] Value ();
}
```

<h3 id='Android.Annotation.ITargetApi'>New Type: Android.Annotation.ITargetApi</h3>

```
public interface ITargetApi : Java.Lang.Annotation.IAnnotation, IDisposable, Android.Runtime.IJavaObject {
	
	int Value ();
}
```

<h3 id='Android.Annotation.SuppressLint'>Type Changed: Android.Annotation.SuppressLint</h3>

Removed:

```
public abstract class SuppressLint : Java.Lang.Object, Java.Lang.Annotation.IAnnotation {
```
...
<h3 id='Android.Annotation.TargetApi'>Type Changed: Android.Annotation.TargetApi</h3>

Removed:

```
public abstract class TargetApi : Java.Lang.Object, Java.Lang.Annotation.IAnnotation {
```
...
<h3 id='Android.Media.MediaActionSound'>Type Changed: Android.Media.MediaActionSound</h3>

Added:

```
public System.Threading.Tasks.Task LoadAsync (MediaActionSoundType soundName);
```

<h3 id='Android.Media.MediaExtractor'>Type Changed: Android.Media.MediaExtractor</h3>

Added:

```
public System.Threading.Tasks.Task<bool> AdvanceAsync ();
 	public System.Threading.Tasks.Task<int> ReadSampleDataAsync (Java.Nio.ByteBuffer byteBuf, int offset);
...
<h3 id='Android.Util.AtomicFile'>Type Changed: Android.Util.AtomicFile</h3>
...
public System.Threading.Tasks.Task FailWriteAsync (System.IO.Stream str);
 	...
 	public System.Threading.Tasks.Task<byte []> ReadFullyAsync ();
...
<h3 id='Android.Webkit.IJavascriptInterface'>New Type: Android.Webkit.IJavascriptInterface</h3>

```
public interface IJavascriptInterface : Java.Lang.Annotation.IAnnotation, IDisposable, Android.Runtime.IJavaObject {
}
```

<h3 id='Android.Webkit.JavascriptInterface'>Type Changed: Android.Webkit.JavascriptInterface</h3>
