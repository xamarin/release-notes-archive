---
id: DBB745D7-EB71-4829-9A6A-2E4E85BA246E
...
```
 ...
 <a name="Namespace:_Android.Accounts" class="injected"></a>


<h2 id='Android.Accounts'>Namespace: Android.Accounts</h2>

 <a name="Type_Changed:_Android.Accounts.AccountsException" class="injected"></a>


<h3 id='Android.Accounts.AccountsException'>Type Changed: Android.Accounts.AccountsException</h3>
...
```
 ...
 <a name="Type_Changed:_Android.Accounts.AuthenticatorException" class="injected"></a>


<h3 id='Android.Accounts.AuthenticatorException'>Type Changed: Android.Accounts.AuthenticatorException</h3>
...
```
 ...
 <a name="Type_Changed:_Android.Accounts.NetworkErrorException" class="injected"></a>


<h3 id='Android.Accounts.NetworkErrorException'>Type Changed: Android.Accounts.NetworkErrorException</h3>
...
```
 ...
 <a name="Type_Changed:_Android.Accounts.OperationCanceledException" class="injected"></a>


<h3 id='Android.Accounts.OperationCanceledException'>Type Changed: Android.Accounts.OperationCanceledException</h3>
...
<h2 id='Android.Content'>Namespace: Android.Content</h2>
 ...
 <a name="Type_Changed:_Android.Content.ContentProviderResult" class="injected"></a>


<h3 id='Android.Content.ContentProviderResult'>Type Changed: Android.Content.ContentProviderResult</h3>
...
```
 ...
 <a name="Type_Changed:_Android.Content.OperationApplicationException" class="injected"></a>


<h3 id='Android.Content.OperationApplicationException'>Type Changed: Android.Content.OperationApplicationException</h3>
...
<h2 id='Android.Content.PM'>Namespace: Android.Content.PM</h2>
 ...
 <a name="Type_Changed:_Android.Content.PM.LabeledIntent" class="injected"></a>


<h3 id='Android.Content.PM.LabeledIntent'>Type Changed: Android.Content.PM.LabeledIntent</h3>
...
<h2 id='Android.Widget'>Namespace: Android.Widget</h2>
 ...
 <a name="Type_Changed:_Android.Widget.QuickContactBadge" class="injected"></a>
