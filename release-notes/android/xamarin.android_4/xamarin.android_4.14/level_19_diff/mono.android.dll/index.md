...
```
public CertPath GenerateCertPath (System.IO.Stream inputStream, string encoding);
	public System.Threading.Tasks.Task<CertPath> GenerateCertPathAsync (System.IO.Stream inputStream, string encoding);
```
...
public virtual void Clear (int fromIndex, int toIndex);
	...
	public virtual int PreviousClearBit (int index);
	public virtual int PreviousSetBit (int index);
	...
	public static BitSet ValueOf (Java.Nio.ByteBuffer byteBuffer);
	public static BitSet ValueOf (Java.Nio.LongBuffer longBuffer);
...
```
public ConcurrentModificationException (string detailMessage, Java.Lang.Throwable cause);
...
```
public JarOutputStream (System.IO.Stream os, Manifest manifest);
```
...
```
public virtual int Deflate (byte[] buf, int offset, int byteCount, int flush);
	...
	public System.Threading.Tasks.Task<int> DeflateAsync (byte[] buf, int offset, int byteCount, int flush);
...
```
public DeflaterOutputStream (System.IO.Stream os, bool syncFlush);
	public DeflaterOutputStream (System.IO.Stream os, Deflater def, bool syncFlush);
	public DeflaterOutputStream (System.IO.Stream os, Deflater def, int bufferSize);
	public DeflaterOutputStream (System.IO.Stream os, Deflater def, int bufferSize, bool syncFlush);
```
...
```
public GZIPOutputStream (System.IO.Stream os, bool syncFlush);
	public GZIPOutputStream (System.IO.Stream os, int bufferSize);
	public GZIPOutputStream (System.IO.Stream os, int bufferSize, bool syncFlush);
```
...
public InflaterInputStream (System.IO.Stream is, Inflater inflater);
	public InflaterInputStream (System.IO.Stream is, Inflater inflater, int bufferSize);
```
...
```
public ZipOutputStream (System.IO.Stream p1);
```

Added constructor:

```
public ZipOutputStream (System.IO.Stream os);
```
...
```
public void UpdateAAD (byte[] input);
	public void UpdateAAD (byte[] input, int inputOffset, int inputLen);
	public void UpdateAAD (Java.Nio.ByteBuffer input);
```
...
```
protected virtual void EngineUpdateAAD (byte[] input, int inputOffset, int inputLen);
	protected virtual void EngineUpdateAAD (Java.Nio.ByteBuffer input);
```
