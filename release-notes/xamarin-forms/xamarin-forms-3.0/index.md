---
id: 403D44E4-6B74-4584-914D-BF01CB8E6BB6
...
* [Github #2576](https://github.com/xamarin/Xamarin.Forms/issues/2576) - "Regression - Android - Exception thrown when page is popped" ([#2828](https://github.com/xamarin/Xamarin.Forms/pull/2828))
* [Github #2653](https://github.com/xamarin/Xamarin.Forms/issues/2653) - "[UWP] Grid insert z-order on UWP broken in Forms 3" ([#2949](https://github.com/xamarin/Xamarin.Forms/pull/2949))
* [Github #2736](https://github.com/xamarin/Xamarin.Forms/issues/2736) - "[iOS] WebView.Source URL's are HTML encoded in Xamarin.Forms 3.0.0.482510" ([#2854](https://github.com/xamarin/Xamarin.Forms/pull/2854))
* [Github #2936](https://github.com/xamarin/Xamarin.Forms/issues/2936) - "3.0.0 vertical text alignment broken in android searchbar" ([#2969](https://github.com/xamarin/Xamarin.Forms/pull/2969))
* [Github #2943](https://github.com/xamarin/Xamarin.Forms/issues/2943) - "[UWP] Last element in grid is rendered with lowest Z-Index" ([#2949](https://github.com/xamarin/Xamarin.Forms/pull/2949))
* [Github #2981](https://github.com/xamarin/Xamarin.Forms/issues/2981) - "[UWP] ListView with null ItemsSource does not updates value if List is set to bound source" ([#2976](https://github.com/xamarin/Xamarin.Forms/pull/2976))
...
* [Github #1946](https://github.com/xamarin/Xamarin.Forms/issues/1946) - "the screen reader doesn't read text on screen like label's and other images, It only reads interactive elements like buttons." ([#2876](https://github.com/xamarin/Xamarin.Forms/pull/2876))
* [Github #2835](https://github.com/xamarin/Xamarin.Forms/issues/2835) - "ResourceProvider Exception in Xamarin.Forms 3.0 due to Signature Change" ([#2880](https://github.com/xamarin/Xamarin.Forms/pull/2880))
* [Github #2929](https://github.com/xamarin/Xamarin.Forms/issues/2929) - "[UWP] ListView with null ItemsSource crashes on 3.0.0.530893" ([#2934](https://github.com/xamarin/Xamarin.Forms/pull/2934))
...
* [Github #2633](https://github.com/xamarin/Xamarin.Forms/issues/2633) - "Exception at  Xamarin.Forms.Platform.UWP.SearchBarRenderer.OnControlLoaded after upgrading to 3.0" ([#2717](https://github.com/xamarin/Xamarin.Forms/pull/2717))
