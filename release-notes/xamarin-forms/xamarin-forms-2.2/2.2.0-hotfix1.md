---
id: DE70C402-C952-49BD-A287-68A577897742
title: "Xamarin.Forms 2.2.0-hotfix1"
---

## News ##
In parallel to this 2.2.0 hotfix release, Nuget packages for [Xamarin.Forms 2.3.0-pre3](https://www.nuget.org/packages/Xamarin.Forms/2.3.0.42-pre3) and [Xamarin.Forms.CarouselView 2.3.0-pre1](https://www.nuget.org/packages/Xamarin.Forms.CarouselVIew) were also shipped. As the CarouselView's version suggests, it has a dependency on Xamarin.Forms 2.3.0 ("-pre3" or greater).
