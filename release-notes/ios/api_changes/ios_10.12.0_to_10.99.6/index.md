...
<p>Added properties:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public virtual CoreGraphics.CGSize PreferredPresentationSize { get; set; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual UIKit.UIPreferredPresentationStyle PreferredPresentationStyle { get; set; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual string SuggestedName { get; set; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual NSData TeamData { get; set; }</span>
</pre>
</div>
<div>
<p>Added methods:</p>
...
<!-- start type MKUserTrackingBarButtonItem --> <div>
<h3>Type Changed: MapKit.MKUserTrackingBarButtonItem</h3>
<div>
<p>Added interface:</p>
<pre>
	<span class='added added-interface ' data-is-non-breaking="">UIKit.IUISpringLoadedInteractionSupporting</span>
</pre>
</div>

</div> <!-- end type MKUserTrackingBarButtonItem -->
...
</div><div data-is-breaking="">	public const string Version = <span class='removed removed-inline removed-breaking-inline'>"10.12.0"</span> <span class='added '>"10.99.6"</span>;
</div></pre>
<div>
<p>Added fields:</p>
<pre>
...
<!-- start type UIActivityType --> <div>
<h3>Type Changed: UIKit.UIActivityType</h3>
<div>
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public static Foundation.NSString MarkupAsPdf { get; }</span>
</pre>
</div>

</div> <!-- end type UIActivityType -->
<!-- start type UIApplicationDelegate --> <div>
<h3>Type Changed: UIKit.UIApplicationDelegate</h3>
<div>
<p>Added method:</p>
<pre>
	<span class='added added-method ' data-is-non-breaking="">public virtual void HandleIntent (UIApplication application, Intents.INIntent intent, System.Action&lt;Intents.INIntentResponse&gt; completionHandler);</span>
</pre>
</div>
...
<p>Added method:</p>
<pre>
	<span class='added added-method ' data-is-non-breaking="">public static void HandleIntent (IUIApplicationDelegate This, UIApplication application, Intents.INIntent intent, System.Action&lt;Intents.INIntentResponse&gt; completionHandler);</span>
</pre>
</div>
...
<p>Added interface:</p>
<pre>
	<span class='added added-interface ' data-is-non-breaking="">IUISpringLoadedInteractionSupporting</span>
</pre>
</div>
<div>
<p>Added property:</p>
...
public class ARPointCloud : Foundation.NSObject, Foundation.INSObjectProtocol, ObjCRuntime.INativeObject, System.IDisposable, System.IEquatable&lt;Foundation.NSObject&gt; {
	...
	<span class='added added-property ' data-is-non-breaking="">public ulong[] Identifiers { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public OpenTK.Vector3[] Points { get; }</span>
	// methods
	<span class='added added-method ' data-is-non-breaking="">protected virtual IntPtr GetRawIdentifiers ();</span>
	<span class='added added-method ' data-is-non-breaking="">protected virtual IntPtr GetRawPoints ();</span>
}
</pre>
