...
<p>Added properties:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public virtual UIKit.UIColor InteriorColor { get; set; }</span>
...
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public static Foundation.NSString ApplicationInfoBundleIdentifierKey { get; }</span>
</pre>
</div>
<div>
<p>Added method:</p>
<pre>
	<span class='added added-method ' data-is-non-breaking="">public virtual void BroadcastAnnotated (Foundation.NSDictionary applicationInfo);</span>
</pre>
</div>
...
<p>Modified properties:</p>
<pre>
<div data-is-non-breaking="">	public <span class='added '>virtual</span> SKCloudServiceSetupAction? Action { get; set; }
</div></pre>
