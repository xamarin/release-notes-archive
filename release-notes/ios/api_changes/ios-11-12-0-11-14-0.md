---
title: "Xamarin.iOS SDK API diff: 11.12.0 vs 11.14.0"
description: List of API changes between Xamarin.iOS versions 11.12.0 and 11.14.0.
author: spouliot
ms.author: sepoulio
ms.date: 6/14/2018
ms.topic: article
ms.assetid: e7a8adee-820d-4941-ad4e-292869b5bdf7
ms.prod: xamarin
---

# Xamarin.iOS SDK API diff: 11.12.0 vs 11.14.0
