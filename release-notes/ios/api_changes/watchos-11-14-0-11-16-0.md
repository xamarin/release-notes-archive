---
title: "Xamarin.WatchOS SDK API diff: 11.14.0 vs 11.16.0"
description: List of API changes between Xamarin.WatchOS versions 11.14.0 and 11.16.0.
author: spouliot
ms.author: sepoulio
ms.date: 8/24/2018
ms.topic: article
ms.assetid: 0f19790b-b6bb-4fd0-a538-e975da6ff078
ms.prod: xamarin
---

# Xamarin.WatchOS SDK API diff: 11.14.0 vs 11.16.0
...
+public const string Version = "11.16.0";
```
