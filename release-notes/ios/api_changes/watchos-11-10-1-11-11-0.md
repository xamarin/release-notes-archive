---
title: "Xamarin.WatchOS SDK API diff: 11.10.1 vs 11.11.0"
description: List of API changes between Xamarin.WatchOS versions 11.10.1 and 11.11.0.
author: spouliot
ms.author: sepoulio
ms.date: 5/25/2018
ms.topic: article
ms.assetid: 82d1086b-b460-402d-bfb8-4d948b575204
ms.prod: xamarin
---

# Xamarin.WatchOS SDK API diff: 11.10.1 vs 11.11.0
