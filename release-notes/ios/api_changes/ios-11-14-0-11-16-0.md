---
title: "Xamarin.iOS SDK API diff: 11.14.0 vs 11.16.0"
description: List of API changes between Xamarin.iOS versions 11.14.0 and 11.16.0.
author: spouliot
ms.author: sepoulio
ms.date: 8/24/2018
ms.topic: article
ms.assetid: 1162429d-5227-4737-93c3-7ff4ddad5e20
ms.prod: xamarin
---

# Xamarin.iOS SDK API diff: 11.14.0 vs 11.16.0
