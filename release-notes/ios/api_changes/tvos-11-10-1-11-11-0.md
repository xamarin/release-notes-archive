---
title: "Xamarin.TVOS SDK API diff: 11.10.1 vs 11.11.0"
description: List of API changes between Xamarin.TVOS versions 11.10.1 and 11.11.0.
author: spouliot
ms.author: sepoulio
ms.date: 5/25/2018
ms.topic: article
ms.assetid: 92e12994-a479-46f2-9e7a-7e1abd8cab0f
ms.prod: xamarin
---

# Xamarin.TVOS SDK API diff: 11.10.1 vs 11.11.0
