---
title: "Xamarin.TVOS SDK API diff: 11.14.0 vs 11.16.0"
description: List of API changes between Xamarin.TVOS versions 11.14.0 and 11.16.0.
author: spouliot
ms.author: sepoulio
ms.date: 8/24/2018
ms.topic: article
ms.assetid: dc88d34f-56e4-41f4-8a22-62201f89fc59
ms.prod: xamarin
---

# Xamarin.TVOS SDK API diff: 11.14.0 vs 11.16.0
