---
title: "Xamarin.WatchOS SDK API diff: 12.0.0 vs 12.2."
description: List of API changes between Xamarin.WatchOS versions 12.0.0 and 12.2..
author: spouliot
ms.author: sepoulio
ms.date: 9/20/2018
ms.topic: article
ms.assetid: 6a7c9bdc-ce63-4271-a75d-52fd5e2404e4
ms.prod: xamarin
---

# Xamarin.WatchOS SDK API diff: 12.0.0 vs 12.2.
