---
id: D79D3DCF-59C6-4EF3-9018-EE1092A4C355
title: "tvOS 10.12.0 to 10.99.8"
---
...
<div data-is-non-breaking="">	<span class='obsolete obsolete-method' data-is-non-breaking="">[Obsolete ("Use 'GetMetadataForFormat' with enum values AVMetadataFormat.")]
	public AVMetadataItem[] MetadataForFormat (string format);</span>
</div></pre>
<p>Modified methods:</p>
<pre>
<div data-is-breaking="">	public <span class='removed removed-inline removed-breaking-inline'>virtual</span> AVMetadataItem[] MetadataForFormat (string format)
</div></pre>
<div>
<p>Added methods:</p>
<pre>
...
public class AVCameraCalibrationData : Foundation.NSObject, Foundation.INSObjectProtocol, ObjCRuntime.INativeObject, System.IDisposable, System.IEquatable&lt;Foundation.NSObject&gt; {
	...
	<span class='added added-property ' data-is-non-breaking="">public virtual OpenTK.Matrix3 GetIntrinsicMatrix { get; }</span>
...
public class AVDepthData : Foundation.NSObject, Foundation.INSObjectProtocol, ObjCRuntime.INativeObject, System.IDisposable, System.IEquatable&lt;Foundation.NSObject&gt; {
	...
	// properties
	<span class='added added-property ' data-is-non-breaking="">public virtual Foundation.NSNumber[] AvailableDepthDataTypes { get; }</span>
	...
	// methods
	<span class='added added-method ' data-is-non-breaking="">public virtual AVDepthData Create (CoreVideo.CVPixelFormatType depthDataType);</span>
	<span class='added added-method ' data-is-non-breaking="">public virtual AVDepthData Create (ImageIO.CGImagePropertyOrientation exifOrientation);</span>
	<span class='added added-method ' data-is-non-breaking="">public virtual AVDepthData Create (CoreVideo.CVPixelBuffer pixelBuffer, Foundation.NSError outError);</span>
...
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat3x3 Rotation3x3 { get; set; }</span>
</pre>
</div>
...
public class MTLArgumentDescriptor : Foundation.NSObject, Foundation.INSCopying, Foundation.INSObjectProtocol, ObjCRuntime.INativeObject, System.IDisposable, System.IEquatable&lt;Foundation.NSObject&gt; {
	...
	<span class='added added-property ' data-is-non-breaking="">public static MTLArgumentDescriptor ArgumentDescriptor { get; }</span>
...
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat4x4 ProjectionMatrix4x4 { get; }</span>
</pre>
</div>
...
<p>Added constructor:</p>
<pre>
	<span class='added added-constructor ' data-is-non-breaking="">public MDLMaterialProperty (string name, MDLMaterialSemantic semantic, Simd.MatrixFloat4x4 value);</span>
</pre>
</div>
<p>Obsoleted properties:</p>
<pre>
...
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat4x4 MatrixFloat4x4 { get; set; }</span>
</pre>
</div>
...
<p>Added properties:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat4x4 LeftProjectionMatrix4x4 { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat4x4 LeftViewMatrix4x4 { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat4x4 RightProjectionMatrix4x4 { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public Simd.MatrixFloat4x4 RightViewMatrix4x4 { get; }</span>
</pre>
</div>
...
<p>Added constructors:</p>
<pre>
	<span class='added added-constructor ' data-is-non-breaking="">public MDLTransform (Simd.MatrixFloat4x4 matrix);</span>
	<span class='added added-constructor ' data-is-non-breaking="">public MDLTransform (Simd.MatrixFloat4x4 matrix, bool resetsTransform);</span>
</pre>
</div>
<p>Obsoleted methods:</p>
<pre>
...
<p>Added methods:</p>
<pre>
	<span class='added added-method ' data-is-non-breaking="">public static Simd.MatrixFloat4x4 CreateGlobalTransform4x4 (MDLObject obj, double atTime);</span>
	<span class='added added-method ' data-is-non-breaking="">public Simd.MatrixFloat4x4 GetRotationMatrix4x4 (double atTime);</span>
	<span class='added added-method ' data-is-non-breaking="">public void SetMatrix4x4 (Simd.MatrixFloat4x4 matrix, double time);</span>
</pre>
</div>
...
<p>Added methods:</p>
<pre>
	<span class='added added-method ' data-is-non-breaking="">public static Simd.MatrixFloat4x4 GetLocalTransform4x4 (IMDLTransformComponent This, double time);</span>
	<span class='added added-method ' data-is-non-breaking="">public static Simd.MatrixFloat4x4 GetMatrix4x4 (IMDLTransformComponent self);</span>
	<span class='added added-method ' data-is-non-breaking="">public static void SetLocalTransform4x4 (IMDLTransformComponent This, Simd.MatrixFloat4x4 transform);</span>
	<span class='added added-method ' data-is-non-breaking="">public static void SetLocalTransform4x4 (IMDLTransformComponent This, Simd.MatrixFloat4x4 transform, double time);</span>
	<span class='added added-method ' data-is-non-breaking="">public static void SetMatrix4x4 (IMDLTransformComponent self, Simd.MatrixFloat4x4 value);</span>
</pre>
</div>
...
public struct MDLVoxelIndexExtent2 {
	...
	<span class='added added-constructor ' data-is-non-breaking="">public MDLVoxelIndexExtent2 (Simd.VectorInt4 minimumExtent, Simd.VectorInt4 maximumExtent);</span>
	// properties
	<span class='added added-property ' data-is-non-breaking="">public Simd.VectorInt4 MaximumExtent { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public Simd.VectorInt4 MinimumExtent { get; }</span>
}
</pre>
...
</div><div data-is-breaking="">	public const string Version = <span class='removed removed-inline removed-breaking-inline'>"10.12.0"</span> <span class='added '>"10.99.8"</span>;
</div></pre>
<div>
<p>Added fields:</p>
<pre>
...
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public static string IOSurfaceLibrary { get; }</span>
</pre>
</div>
...
<p>Added properties:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public virtual Simd.MatrixFloat2x2 MatrixFloat2x2Value { get; set; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual Simd.MatrixFloat3x3 MatrixFloat3x3Value { get; set; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual Simd.MatrixFloat4x4 MatrixFloat4x4Value { get; set; }</span>
</pre>
</div>
<p>Obsoleted methods:</p>
<pre>
...
public class SKTransformNode : SpriteKit.SKNode, Foundation.INSCoding, Foundation.INSCopying, Foundation.INSObjectProtocol, ObjCRuntime.INativeObject, System.Collections.Generic.IEnumerable&lt;SKNode&gt;, System.Collections.IEnumerable, System.IDisposable, System.IEquatable&lt;Foundation.NSObject&gt;, UIKit.IUIFocusEnvironment, UIKit.IUIFocusItem {
	...
	// properties
	<span class='added added-property ' data-is-non-breaking="">public override IntPtr ClassHandle { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual Simd.VectorFloat3 EulerAngles { get; set; }</span>
...
public struct MatrixFloat2x2, System.IEquatable&lt;MatrixFloat2x2&gt; {
	...
	<span class='added added-constructor ' data-is-non-breaking="">public MatrixFloat2x2 (VectorFloat2 column0, VectorFloat2 column1);</span>
...
public struct MatrixFloat3x3, System.IEquatable&lt;MatrixFloat3x3&gt; {
	...
	<span class='added added-constructor ' data-is-non-breaking="">public MatrixFloat3x3 (VectorFloat3 column0, VectorFloat3 column1, VectorFloat3 column2);</span>
...
public struct MatrixFloat4x4, System.IEquatable&lt;MatrixFloat4x4&gt; {
	...
	<span class='added added-constructor ' data-is-non-breaking="">public MatrixFloat4x4 (VectorFloat4 column0, VectorFloat4 column1, VectorFloat4 column2, VectorFloat4 column3);</span>
...
<div> <!-- start type VectorFloat2 -->
<h3>New Type Simd.VectorFloat2</h3>
<pre class='added' data-is-non-breaking="">
public struct VectorFloat2, System.IEquatable&lt;VectorFloat2&gt; {
	// constructors
	<span class='added added-constructor ' data-is-non-breaking="">public VectorFloat2 (float x, float y);</span>
	// fields
	<span class='added added-field ' data-is-non-breaking="">public float X;</span>
	<span class='added added-field ' data-is-non-breaking="">public float Y;</span>
	// methods
	<span class='added added-method ' data-is-non-breaking="">public virtual bool Equals (VectorFloat2 other);</span>
	<span class='added added-method ' data-is-non-breaking="">public override bool Equals (object obj);</span>
	<span class='added added-method ' data-is-non-breaking="">public override int GetHashCode ();</span>
	<span class='added added-method ' data-is-non-breaking="">public override string ToString ();</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Equality (VectorFloat2 left, VectorFloat2 right);</span>
	<span class='added added-method ' data-is-non-breaking="">public static VectorFloat2 op_Explicit (OpenTK.Vector2 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static OpenTK.Vector2 op_Explicit (VectorFloat2 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Inequality (VectorFloat2 left, VectorFloat2 right);</span>
}
</pre>
</div> <!-- end type VectorFloat2 -->
<div> <!-- start type VectorFloat3 -->
<h3>New Type Simd.VectorFloat3</h3>
<pre class='added' data-is-non-breaking="">
public struct VectorFloat3, System.IEquatable&lt;VectorFloat3&gt; {
	// constructors
	<span class='added added-constructor ' data-is-non-breaking="">public VectorFloat3 (float x, float y, float z);</span>
	// fields
	<span class='added added-field ' data-is-non-breaking="">public float X;</span>
	<span class='added added-field ' data-is-non-breaking="">public float Y;</span>
	<span class='added added-field ' data-is-non-breaking="">public float Z;</span>
	// methods
	<span class='added added-method ' data-is-non-breaking="">public virtual bool Equals (VectorFloat3 other);</span>
	<span class='added added-method ' data-is-non-breaking="">public override bool Equals (object obj);</span>
	<span class='added added-method ' data-is-non-breaking="">public override int GetHashCode ();</span>
	<span class='added added-method ' data-is-non-breaking="">public override string ToString ();</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Equality (VectorFloat3 left, VectorFloat3 right);</span>
	<span class='added added-method ' data-is-non-breaking="">public static VectorFloat3 op_Explicit (OpenTK.Vector3 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static OpenTK.Vector3 op_Explicit (VectorFloat3 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Inequality (VectorFloat3 left, VectorFloat3 right);</span>
}
</pre>
</div> <!-- end type VectorFloat3 -->
<div> <!-- start type VectorFloat4 -->
<h3>New Type Simd.VectorFloat4</h3>
<pre class='added' data-is-non-breaking="">
public struct VectorFloat4, System.IEquatable&lt;VectorFloat4&gt; {
	// constructors
	<span class='added added-constructor ' data-is-non-breaking="">public VectorFloat4 (float x, float y, float z, float w);</span>
	// fields
	...
	<span class='added added-field ' data-is-non-breaking="">public float Z;</span>
	// methods
	<span class='added added-method ' data-is-non-breaking="">public virtual bool Equals (VectorFloat4 other);</span>
	<span class='added added-method ' data-is-non-breaking="">public override bool Equals (object obj);</span>
	<span class='added added-method ' data-is-non-breaking="">public override int GetHashCode ();</span>
	<span class='added added-method ' data-is-non-breaking="">public override string ToString ();</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Equality (VectorFloat4 left, VectorFloat4 right);</span>
	<span class='added added-method ' data-is-non-breaking="">public static VectorFloat4 op_Explicit (OpenTK.Vector4 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static OpenTK.Vector4 op_Explicit (VectorFloat4 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Inequality (VectorFloat4 left, VectorFloat4 right);</span>
}
</pre>
</div> <!-- end type VectorFloat4 -->
<div> <!-- start type VectorInt4 -->
<h3>New Type Simd.VectorInt4</h3>
<pre class='added' data-is-non-breaking="">
public struct VectorInt4, System.IEquatable&lt;VectorInt4&gt; {
	// constructors
	<span class='added added-constructor ' data-is-non-breaking="">public VectorInt4 (int x, int y, int z, int w);</span>
	// fields
	<span class='added added-field ' data-is-non-breaking="">public int W;</span>
	<span class='added added-field ' data-is-non-breaking="">public int X;</span>
	<span class='added added-field ' data-is-non-breaking="">public int Y;</span>
	<span class='added added-field ' data-is-non-breaking="">public int Z;</span>
	// methods
	<span class='added added-method ' data-is-non-breaking="">public virtual bool Equals (VectorInt4 other);</span>
	<span class='added added-method ' data-is-non-breaking="">public override bool Equals (object obj);</span>
	<span class='added added-method ' data-is-non-breaking="">public override int GetHashCode ();</span>
	<span class='added added-method ' data-is-non-breaking="">public override string ToString ();</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Equality (VectorInt4 left, VectorInt4 right);</span>
	<span class='added added-method ' data-is-non-breaking="">public static VectorInt4 op_Explicit (OpenTK.Vector4i value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static OpenTK.Vector4i op_Explicit (VectorInt4 value);</span>
	<span class='added added-method ' data-is-non-breaking="">public static bool op_Inequality (VectorInt4 left, VectorInt4 right);</span>
}
</pre>
</div> <!-- end type VectorInt4 -->
...
public class VNImageHomographicAlignmentObservation : Vision.VNImageAlignmentObservation, Foundation.INSCoding, Foundation.INSCopying, Foundation.INSObjectProtocol, Foundation.INSSecureCoding, ObjCRuntime.INativeObject, System.IDisposable, System.IEquatable&lt;Foundation.NSObject&gt; {
	...
	// properties
	<span class='added added-property ' data-is-non-breaking="">public override IntPtr ClassHandle { get; }</span>
	<span class='added added-property ' data-is-non-breaking="">public virtual Simd.MatrixFloat3x3 WarpTransform { get; set; }</span>
}
</pre>
...
public static class VNUtils {
	...
	<span class='added added-method ' data-is-non-breaking="">public static CoreGraphics.CGPoint GetImagePoint (Simd.VectorFloat2 faceLandmarkPoint, CoreGraphics.CGRect faceBoundingBox, uint imageWidth, uint imageHeight);</span>
	...
	<span class='added added-method ' data-is-non-breaking="">public static CoreGraphics.CGPoint GetNormalizedFaceBoundingBoxPoint (Simd.VectorFloat2 faceLandmarkPoint, CoreGraphics.CGRect faceBoundingBox, uint imageWidth, uint imageHeight);</span>
