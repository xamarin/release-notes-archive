---
title: "Xamarin.iOS SDK API diff: 11.10.1 vs 11.11.0"
description: List of API changes between Xamarin.iOS versions 11.10.1 and 11.11.0.
author: spouliot
ms.author: sepoulio
ms.date: 5/25/2018
ms.topic: article
ms.assetid: 62be6a99-3cd8-478a-b69c-9bd4beb08d4d
ms.prod: xamarin
---

# Xamarin.iOS SDK API diff: 11.10.1 vs 11.11.0
