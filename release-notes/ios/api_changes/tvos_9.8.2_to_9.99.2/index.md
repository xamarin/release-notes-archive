...
<p>Added property:</p>
<pre>
	<span class='added added-property ' data-is-non-breaking="">public virtual NSString CalendarIdentifier { get; }</span>
</pre>
</div>
<div>
<p>Added method:</p>
<pre>
	<span class='added added-method ' data-is-non-breaking="">public virtual string GetLocalizedString (NSString calendarIdentifier);</span>
</pre>
</div>
...
</div><div data-is-breaking="">	public const string Version = <span class='removed removed-inline removed-breaking-inline'>"9.8.2"</span> <span class='added '>"9.99.2"</span>;
</div></pre>
<div>
<p>Added fields:</p>
<pre>
