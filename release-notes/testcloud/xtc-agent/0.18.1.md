---
id: AD273AE5-2A0B-4B1D-A032-51074623C1C7
title: "Calabash iOS 0.18.1"
---
...
* App bundle detection has been improved.  It is not clear if the changes will
  work for all users. @ark-konopacki
* `calabash-ios check` correctly detects the Calabash iOS server
